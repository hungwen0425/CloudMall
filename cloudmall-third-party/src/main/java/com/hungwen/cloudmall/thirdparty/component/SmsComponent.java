...
public class SmsComponent {
	...
	@Value("${cloudmall.sms.sendSMSUrl}")
	private String sendSMSUrl;
	@Value("${cloudmall.sms.getCreditUrl}")
	private String getCreditUrl;
	@Value("${cloudmall.sms.userID}")
	String userID;
	@Value("${cloudmall.sms.password}")
	String password;
	@Value("${cloudmall.sms.credit}")
	 ...
	 *                 格式為 YYYYMMDDhhmnss；例如:預約 2009/01/31 15:30:00發送，則傳入20090131153000。若傳遞時間已逾現在之時間，將立即發送。
